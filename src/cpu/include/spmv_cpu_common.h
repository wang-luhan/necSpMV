...
#define nLanes_f32 4
#define nLanes_f64 2
#define IRD_thr_fp32 0.543 // Kunpeng920
#define IRD_thr_fp64 0.76  // Kunpeng920
#endif
#ifdef X86_SIMD
#include <immintrin.h>
...
#define nLanes_f64 8
#define IRD_thr_fp32 0.437 // Intel Xeon Gold 6240
#define IRD_thr_fp64 0.477 // Intel Xeon Gold 6240
#endif
...
#ifdef X86_SIMD
always_inline void AVX512_spvv_cross_row_fp32(const int *rows, int *row_begin, int *row_end, int *col, float *nnz, float *x, perfSpB_vector y)
{
...
always_inline void AVX512_spvv_cross_row_fp64(const int *rows, int *row_begin, int *row_end, int *col, double *nnz, double *x, perfSpB_vector y)
{
    perfSpB_vector_Dense *yy = (perfSpB_vector_Dense *)(y);
...
always_inline void NEON_spvv_cross_row_fp32(const int *rows, int *row_begin, int *row_end, int *col, float *nnz, float *x, perfSpB_vector y)
{
    perfSpB_vector_Dense *yy = (perfSpB_vector_Dense *)(y);
...
always_inline void NEON_spvv_cross_row_fp64(const int *rows, int *row_begin, int *row_end, int *col, double *nnz, double *x, perfSpB_vector y)
{
    perfSpB_vector_Dense *yy = (perfSpB_vector_Dense *)(y);
